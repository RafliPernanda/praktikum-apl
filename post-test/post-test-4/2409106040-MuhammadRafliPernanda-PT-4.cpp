...
void tambahCatatan(bool pemasukan) {
...
void lihatTotal(bool pemasukan) {
    double total = 0;
...
void menuUtama() {
    ...
    while (true) {
        ...
        switch (pilihan) {
            case 1: tambahCatatan(true); break;
            case 2: tambahCatatan(false); break;
            case 3: lihatTotal(true); break;
            case 4: lihatTotal(false); break;
            case 5: tampilkanSemuaCatatan(); break;
            case 6: editCatatan(); break;
            case 7: hapusCatatan(); break;
            case 8: cout << "\nLogout berhasil!\n\n"; return;
