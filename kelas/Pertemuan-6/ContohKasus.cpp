...
void bubbleSort(Mahasiswa *data, const int &jumlah)
{
    ...
    cout << "Data berhasil diurutkan dengan Bubble Sort berdasarkan nama.\n";
}
...
void selectionSort(Mahasiswa *data, const int &jumlah)
{
    ...
    cout << "Data berhasil diurutkan dengan Selection Sort berdasarkan nama.\n";
}
...
void insertionSort(Mahasiswa *data, const int &jumlah)
{
    ...
    cout << "Data berhasil diurutkan dengan Insertion Sort berdasarkan nama.\n";
}
